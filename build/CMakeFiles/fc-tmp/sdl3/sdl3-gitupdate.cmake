...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-3.4.10"
  WORKING_DIRECTORY "/home/ivan_miatselski/Simple2DEngine/src/engine/third_party/SDL"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-3.4.10")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-3.4.10" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: release-3.4.10")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/release-3.4.10")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"release-3.4.10\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ivan_miatselski/Simple2DEngine/src/engine/third_party/SDL'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ivan_miatselski/Simple2DEngine/src/engine/third_party/SDL'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
